...
if STRUCTURE == "295K":
    ...
    # crystal = io.read( os.path.expanduser("/home/dlbox2/ダウンロード/artificial-rotor/structures/triazine/ipi/test/ktu002-stripped.cif")) 
    # 355 K structure:
    triazine_1 = [6, 8, 10, 102, 104, 106]
    triazine_2 = [9, 7, 11, 103, 105, 107]
    triazine_3 = [270, 272, 274, 366, 368, 370]
...
# ### for testing with stripped structure (to check isolated ring):
# axis_test = [5,4]
# ring_test = [7,9,12,16]
# ###
